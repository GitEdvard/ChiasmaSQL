...
/****** Object:  StoredProcedure [dbo].[p_RestoreOrderDevel]    Script Date: 2021-02-24 1:24:00 PM ******/
SET ANSI_NULLS OFF
GO
...
alter procedure [dbo].[p_RestoreOrderDevel] @latest_release bit = 1, @latest_merge bit = 0

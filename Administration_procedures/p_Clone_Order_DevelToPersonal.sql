...
/****** Object:  StoredProcedure [dbo].[p_Clone_Order_DevelToPersonal]    Script Date: 2021-02-24 1:22:51 PM ******/
SET ANSI_NULLS OFF
GO
...
create procedure [dbo].[p_Clone_Order_DevelToPersonal] @version int = null, @latest_release bit = 1, @latest_merge bit = 0

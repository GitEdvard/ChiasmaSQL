...
/****** Object:  StoredProcedure [dbo].[p_CloneGTDB2DevelLatestMerge]    Script Date: 2014-02-27 14:07:56 ******/
SET ANSI_NULLS OFF
GO
...
create procedure p_CloneGTDB2DevelLatestMerge
...
select @devel_db_name = devel_db_name from map_devel_table where login = SYSTEM_USER and operation_db_name = 'gtdb2'
...
set @sql = @sql + 
'restore database ' + @devel_db_name + ' from disk = ''D:\Scripts\Proc_references\Devel_backups\Latest merge\gtdb2_devel2_backup.bak''

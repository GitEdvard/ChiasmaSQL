USE [GTDB2_devel]
GO
/****** Object:  StoredProcedure [dbo].[p_GetProjectSampleSeriesHistoryForProject]    Script Date: 11/20/2009 16:05:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[p_GetProjectSampleSeriesHistoryForProject]( @project_id INTEGER )
...
AND sample_series_group.identifiable_id = @project_id 

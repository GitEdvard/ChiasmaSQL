USE [GTDB2_devel]
GO
/****** Object:  StoredProcedure [dbo].[p_GetIndividualsChildren]    Script Date: 11/20/2009 16:00:54 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[p_GetIndividualsChildren] (@id INTEGER)
...
WHERE ind.mother_id = @id OR ind.father_id = @id
ORDER BY ind.identifier ASC

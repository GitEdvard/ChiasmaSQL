USE [GTDB2_devel]
GO
/****** Object:  StoredProcedure [dbo].[p_GetProjectRightsHistoryForProject]    Script Date: 11/20/2009 16:04:50 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[p_GetProjectRightsHistoryForProject]( @project_id INTEGER )
...
AND authority_group.identifiable_id = @project_id 

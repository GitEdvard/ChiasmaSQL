USE [GTDB2_devel]
GO
/****** Object:  StoredProcedure [dbo].[p_CheckMarkersInPlus]    Script Date: 11/20/2009 15:54:21 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[p_CheckMarkersInPlus](
...
m.marker_id not in (select marker_id from allele_variant_plus)

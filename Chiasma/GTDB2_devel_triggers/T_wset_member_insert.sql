USE [GTDB2_devel]
GO
/****** Object:  Trigger [dbo].[T_wset_member_insert]    Script Date: 11/20/2009 15:16:18 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

CREATE TRIGGER [dbo].[T_wset_member_insert] ON [dbo].[wset_member]
AFTER INSERT
...
(SELECT wset_type_id FROM wset WHERE wset_id IN (SELECT wset_id FROM inserted)) )
...
BEGIN
	...
	INSERT INTO wset_member_log (identifiable_id, kind_id, wset_id, operation, authority_id) 
		SELECT identifiable_id, kind_id, wset_id, 'I', @authority_id FROM inserted

	USE [GTDB2_devel]
GO
/****** Object:  UserDefinedFunction [dbo].[fGetXAllele]    Script Date: 11/20/2009 14:10:04 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER FUNCTION [dbo].[fGetXAllele](@marker_id INTEGER, @is_bulk BIT, @strand_reference VARCHAR(10))
RETURNS VARCHAR(2)

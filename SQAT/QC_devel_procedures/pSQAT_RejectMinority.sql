USE [QC_devel]
GO
/****** Object:  StoredProcedure [dbo].[pSQAT_RejectMinority]    Script Date: 11/20/2009 16:45:56 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[pSQAT_RejectMinority](@experimentId INTEGER, @majorityPercent INTEGER) 
AS
BEGIN
SET NOCOUNT ON

USE [QC_devel]
GO
/****** Object:  StoredProcedure [dbo].[pSQAT_GetExperimentStatistics]    Script Date: 11/20/2009 16:45:25 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[pSQAT_GetExperimentStatistics](@itemId INTEGER) 
AS
BEGIN
SET NOCOUNT ON

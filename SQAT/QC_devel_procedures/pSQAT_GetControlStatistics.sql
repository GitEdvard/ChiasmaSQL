USE [QC_devel]
GO
/****** Object:  StoredProcedure [dbo].[pSQAT_GetControlStatistics]    Script Date: 11/20/2009 16:45:02 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[pSQAT_GetControlStatistics](@controlItemId INTEGER) 
AS
BEGIN
SET NOCOUNT ON

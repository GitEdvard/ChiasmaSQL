...
USE [QC_devel]
GO
/****** Object:  StoredProcedure [dbo].[pSQAT_GetRerunItems]    Script Date: 11/20/2009 16:45:51 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[pSQAT_GetRerunItems](@UnitMode VARCHAR(10), @missingGenotype BIT, @missingGenotypePercent INTEGER,
